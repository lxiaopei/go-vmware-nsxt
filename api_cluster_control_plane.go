 ...
 func (a *SystemAdministrationPolicyClusterControlPlaneApiService) CreateOrUpdateClusterControlPlane(ctx context.Context, siteId string, enforcementpointId string, clusterControlPlaneId string, clusterControlPlane clustercontrolplane.ClusterControlPlane) (clustercontrolplane.ClusterControlPlane, *http.Response, error) {
	 ...
	 if localVarHttpResponse.StatusCode >= 300 {
		 ...
		 if localVarHttpResponse.StatusCode == 201 {
			 var v clustercontrolplane.ClusterControlPlane
 ...
 */
 func (a *SystemAdministrationPolicyClusterControlPlaneApiService) ListClusterControlPlane(ctx context.Context, siteId string, enforcementpointId string) (ClusterControlPlaneListResult, *http.Response, error) {
	 var (
		 localVarHttpMethod = strings.ToUpper("Get")
		 localVarPostBody   interface{}
		 localVarFileName   string
		 localVarFileBytes  []byte
		 localVarReturnValue ClusterControlPlaneListResult
	 )
	 ...
	 if localVarHttpResponse.StatusCode >= 300 {
		 ...
		 if localVarHttpResponse.StatusCode == 200 {
			 var v ClusterControlPlaneListResult
			 err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				 if err != nil {
					 newErr.error = err.Error()
					 return localVarReturnValue, localVarHttpResponse, newErr
