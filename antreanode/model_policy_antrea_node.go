...
type PolicyAntreaNode struct {
	...
	// This property is used to identify the antrea node in NSX-T. This id should assigned by NSX-T in registration process.
	NodeId string `json:"node_id,omitempty"`
	// This property should be afford in registration process for VHC module requirement.
